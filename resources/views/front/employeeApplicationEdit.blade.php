        ...
        <section id="blog" class="blog">
            <div class="container mt-5">
                <div class="form-container">
                    ...
                    <h3 style="color:#ff0000;">Please Re-check Your Information Before Submit</h3>
                    <p>Please complete this form in its entirety</p>

                    <form class="form-control" action="{{route('employeeApplicationUpdate',$getReviewData->id)}}" method="post" enctype="multipart/form-data" id="form" data-parsley-validate="">
                        @csrf
                        @method('put')
                        ...
                        <div class="section mt-5">
                            <h3>6. Employment History</h3>
                                ...
                                <div class="signature-box">
                                    <p class="mt-4">Signature of Applicant<span style="color:red;padding-left:10px;font-weight:bold;">width-300px and height-80px</span> <input type="file" accept="image/*" class="form-control" name="applicant_signature" /></p>
                                    @if(!empty($getReviewData->applicant_signature))
                                    <img src="{{asset('/')}}{{$getReviewData->applicant_signature}}" style="height: 60px;"/>
                                    @endif
                        ...
                        <div class="file-upload mb-3">
                            ...
                            <input type="file" accept="image/*" class="form-control" id="file-upload" name="applicant_photo" >
                            @if(!empty($getReviewData->applicant_photo))
                            <img src="{{asset('/')}}{{$getReviewData->applicant_photo}}" style="height: 60px;"/>
                            @endif
                        </div>
