    ...
    <table>
        <tr>
            ...
            <td rowspan="2" class="photo-box">
                ...
                ATTACH PHOTO HERE
                @else
                <img src="{{asset('/')}}{{$getReviewData->applicant_photo}}" style="height: 120px;"/>
                @endif
            </td>
        </tr>
        <tr>
    ...
    <table>
        <tr>
            <td>
                ...
                @else
                Signature of Applicant: <img src="{{asset('/')}}{{$getReviewData->applicant_signature}}" style="height: 80px;"/>
                @endif
